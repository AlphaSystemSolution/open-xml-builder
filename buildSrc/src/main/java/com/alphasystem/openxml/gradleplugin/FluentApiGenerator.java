...
import static com.alphasystem.openxml.gradleplugin.CodeModelUtil.*;
import static com.alphasystem.openxml.gradleplugin.ReflectionUtils.getClassName;
...
public class FluentApiGenerator {
    ...
    public FluentApiGenerator(String basePackageName,
                              String builderType,
    ...
    public void generate(String sourcePackageName, File destDir) throws IOException {
